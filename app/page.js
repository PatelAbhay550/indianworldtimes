...
import { db} from '../lib/firebase.js' // Make sure you have your Firebase config set up
import { collection, getDocs, query, where } from 'firebase/firestore';

const IndianWorldTimes = () => {
      ...
      <div className="dark:bg-gray-900 dark:text-white">
        ...
        <div className="bg-black text-white py-2 px-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            ...
            <span className="text-sm">Today: {new Date().toLocaleDateString('en-IN', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
          </div>
          <div className="flex items-center space-x-4">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-1 flex flex-col justify-between">
                      ...
                      <div>
                        ...
                        <button className="mt-4 cursor-pointer  text-red-600 font-medium hover:underline">
                          Read Full Story →
                        </button>
                      </div>
                    </div>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {news.slice(1).map((article, index) => (
                    <article key={index} className="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow dark:border-gray-700">
                      <img
                      ...
                      />
                      <div className="p-4">
                        <span className="text-xs uppercase text-red-600 font-medium">{article.category || activeCategory}</span>
                        ...
                        <div className="flex justify-between items-center text-xs text-gray-500 dark:text-gray-400">
                          ...
                          <button className="text-red-600 hover:underline cursor-pointer">Read More</button>
                        </div>
                      </div>
                    </article>
                  ))}
...
export default IndianWorldTimes;